...
def main():
    ...
    m1 = lgb.train(PARAMS, lgb.Dataset(Xf[m_tr], Y1.ravel()[m_tr]),
    ...
    m2 = lgb.train(PARAMS, lgb.Dataset(X2[t2], y2[t2]), num_boost_round=3000,
    ...
    m3 = lgb.train(PARAMS, lgb.Dataset(X3[t3], y3[t3]), num_boost_round=3000,
